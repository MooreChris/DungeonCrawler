...
export default class Player {
    constructor(scene, x, y) {
        ...
        anims.create({
            key: "player-walk",
            frames: anims.generateFrameNumbers("Player_01", { start: 1, end: 3 }),
            frameRate: 8,
            repeat: -1
        });
        anims.create({
            key: "player-walk-back",
            frames: anims.generateFrameNumbers("Player_01", { start: 13, end: 15 }),
            frameRate: 8,
            repeat: -1
        });

        this.sprite = scene.physics.add
            .sprite(x, y, "Player_01", 0)
            .setSize(22, 33)
            .setOffset(23, 27);
    ...
    update() {
        ...
        if (keys.left.isDown || keys.right.isDown || keys.down.isDown) {
            ...
            if (prevVelocity.y < 0) sprite.setTexture("Player_01", 65);
            else sprite.setTexture("Player_01", 46);
        }
    }
